...
<template>
   ...
   <!-- end of completed  -->
        <div class="flex-1">
            ...
            <form v-if="editing" @submit.prevent="form.put(route('tasks.update', chirp.id), { onSuccess: () => editing = false })">
            ...
            <p v-else class="mt-4 text-lg text-gray-900">{{ task.message }}</p>
